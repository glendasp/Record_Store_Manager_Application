...
public class User_Interface extends JFrame implements WindowListener{
    ...
    public User_Interface(final Record_Catalog_Display_DataModel catalog_display_dataModel, Consigner_Display_DataModel catalogDisplayDataModel){
        ...
        tabbedPane.add("Consigner Information",new Consigner_Maintenece_Tab(catalog_display_dataModel).getPanel());
        setVisible(true);
        pack();
